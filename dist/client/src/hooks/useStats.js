...
export function useUserStats(folderId) {
    var _this = this;
    var sessionId = useSession().sessionId;
    var queryKey = folderId
    ...
    var queryFn = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = folderId
                        ? "/api/stats/user?userId=".concat(sessionId, "&folder=").concat(folderId)
                        : "/api/stats/user?userId=".concat(sessionId);
...
export function useStoryStats(folderId) {
    var _this = this;
    var queryKey = folderId
    ...
    var queryFn = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = folderId
                        ? "/api/stats/stories?folder=".concat(folderId)
                        : "/api/stats/stories";
                    return [4 /*yield*/, fetch(url)];
                case 1:
                    response = _a.sent();
