...
export function useStories(folderId) {
    var _this = this;
    ...
    var queryFn = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = folderId
                        ? "/api/stories?folder=".concat(folderId)
                        : "/api/stories";
...
export function useStory(storyId) {
    var _this = this;
    return useQuery({
        queryKey: ["/api/stories/".concat(storyId)],
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/stories/".concat(storyId))];
                    case 1:
                        response = _a.sent();
                        if (!response.ok)
