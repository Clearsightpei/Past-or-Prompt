...
var SelectContent = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<SelectPrimitive.Content ref={ref} className={cn("relative z-50 min-w-[8rem] overflow-hidden rounded-md border border-[#00ffe0] bg-[#1a3c42] text-[#00ffe0] shadow-md animate-in fade-in-80", className)} {...props}/>);
});
